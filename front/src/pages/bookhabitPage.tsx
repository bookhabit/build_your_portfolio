...
const userInfo:UserInfoType = {
    ...
    name:"이현진",
    _id:"649060df8f0c8613f7649b1c",
    userResumeDoc:{
        name:"이현진",
        nickName:"bookhabit",
        birth:"1998-06-19", // 1998-03-21
        finalEducation:"한서대학교",
        phone:"010-7607-9182", 
        certification:[],
        channel:[{
            channelName: "깃허브",
            channelURL:"https://github.com/bookhabit",
        }], 
        technology:["HTML","CSS","JS","TS","Next.js","Nest.js","React","MongoDB","MySQL","AWS","styled-components","express","node.js","tailwindcss"],
        career:[],
        activity:[{
            activityName:"멋쟁이사자처럼 10기",
            period:{
                start:'2023-04-09',
                end:'2023-12-10'
            },
            activity:[
                '충청톤 참가(대학교 자취방 공유 서비스)','단풍톤 참가(크리스마스 이벤트 편지 서비스)','중앙 해커톤 참가'
            ]
        }],
        myselfSentence:"내 아이디어를 창작해서 실현하는 것을 좋아하는 사람입니다",
        reasonForCoding:"제가 만든 웹사이트를 사람들이 이용해보는 것을 경험해보고 싶습니다",
        coverLetter:"안녕하세요 저는 한서대학교에서 항공컴퓨터학과 졸업예정인 학생입니다.저는 프론트엔드 위주로 웹개발을 공부하고 있고 React와 Next.js를 주로 사용하고 백엔드는 Node.js , Express  , MySQL 또는 몽고DB를 주로 사용합니다.저는 프로젝트를 기획하는 단계부터 한 단계씩 목표를 설정하고 완성해나가면서 성취감을 느끼면서 개발을 하고 있습니다.",
        _id:"6492af0dd0dcd4bea76f9d20",
